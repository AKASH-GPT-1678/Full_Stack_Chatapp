...
const ProfileSettings = () => {
    const [profile, setProfile] = useState({
        ...
        bio: 'Love chatting and connecting with friends!',
        profilePhoto: null
    });
    ...
    async function uploadProfilePhoto(profileFile) {
        ...
        try {
            ...
            const response = await axios.post(`${endpoint}/addprofile`,
            ...
            <div className="max-w-2xl mx-auto">
                ...
                <div className="bg-white rounded-2xl shadow-sm p-6 mb-6">
                    <div className="flex flex-col items-center">
                        ...
                        <h2 className="text-xl font-semibold text-gray-800">{profile.displayName}</h2>
                        <p className="text-gray-500">@{profile.username}</p>
                        {showUploadButton && <button className='p-2 bg-blue-500 hover:bg-blue-600 text-white rounded-full mt-4 px-8 cursor-pointer' onClick={() => uploadProfilePhoto(profileFile)}>Upload</button>}
                    </div>
                </div>
